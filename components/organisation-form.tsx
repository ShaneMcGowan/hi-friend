...
import { ORGANISATION_TYPES, type Organisation } from "@/lib/types"
...
export function OrganisationForm({
  ...
  return (
    <form id={formId} onSubmit={handleSubmit} className="bg-white rounded-xl border border-border/40 p-6 shadow-sm space-y-6">
      <div>
        <h3 className="text-xl font-bold mb-4">{organisation ? "Edit Organisation" : "New Organisation"}</h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            placeholder="e.g., Super Facny Yacht Club"
          />
        </div>
        <div>
        ...
        <div className="md:col-span-2">
          ...
          <input
            ...
            onChange={handleInputChange}
            className="w-full px-3 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-foreground"
            placeholder="What is this place? e.g., Game shop where I play card games"
          />
        </div>
        ...
        <div className="md:col-span-2">
          ...
          <div className="flex gap-2 mb-2">
            <input
              ...
              placeholder="Label (e.g., General, Bookings)"
        ...
        <div className="md:col-span-2">
          ...
          <div className="flex gap-2 mb-2">
            <input
              ...
              placeholder="Label (e.g., Shop, Mobile)"
              className="w-1/3 px-3 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-foreground"
            />
            <input
              type="tel"
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          className="w-full px-3 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-foreground"
          placeholder="Opening hours, who you know there, what happens on which nights..."
        />
      </div>
